...
const DessertBanner = () => {
    return (
        <div className='my-12'>
            <SharedBanner img={bannerImg} pyl="16" title="desserts" description="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officia odio fuga voluptatum praesentium iure velit tempora maiores recusandae excepturi optio?" />
